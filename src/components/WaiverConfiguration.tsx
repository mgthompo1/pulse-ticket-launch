...
interface WaiverConfigurationProps {
  eventId: string;
  organizationId: string;
}

export const WaiverConfiguration: React.FC<WaiverConfigurationProps> = ({
  eventId,
  organizationId,
}) => {
  ...
  const [previewWaiver, setPreviewWaiver] = useState<WaiverTemplate | null>(null);
  ...
  const handleEdit = (waiver: WaiverTemplate) => {
  ...
  const handlePreview = (waiver: WaiverTemplate) => {
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
              ...
              <CardDescription>
                Manage waivers that attendees must sign during check-in
              </CardDescription>
            </div>
            <Dialog open={isDialogOpen} onOpenChange={(open) => {
              ...
              <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
                <DialogHeader>
                  ...
                  <DialogDescription>
                    Configure a waiver template for attendees to sign
                  </DialogDescription>
                </DialogHeader>
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground mt-1">
                      This text will be displayed to attendees during check-in
                    </p>
                  </div>
                  ...
                  <div className="space-y-4 border-t pt-4">
                    ...
                    <div className="flex items-center justify-between">
                      <div className="space-y-0.5">
                        ...
                        <p className="text-sm text-muted-foreground">
                          Only active waivers will be shown during check-in
                        </p>
                      </div>
                      <Switch
                        id="is_active"
                    ...
                    <div className="flex items-center justify-between">
                      <div className="space-y-0.5">
                        ...
                        <p className="text-sm text-muted-foreground">
                          Attendee must provide digital signature
                        </p>
                      </div>
                      <Switch
        ...
        <CardContent>
          {waivers.length === 0 ? (
            <div className="text-center py-8">
              ...
              <p className="text-sm text-muted-foreground">
                Create a waiver template to get started
              </p>
            </div>
          ) : (
      ...
      <Dialog open={previewDialogOpen} onOpenChange={setPreviewDialogOpen}>
        <DialogContent className="max-w-2xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            ...
            <DialogDescription>
              This is how the waiver will appear to attendees
            </DialogDescription>
          </DialogHeader>
          {previewWaiver && (
