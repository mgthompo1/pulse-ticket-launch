...
import { CheckCircle, AlertCircle, Loader2, Facebook } from "lucide-react";
  ...
  useEffect(() => {
    const handleCallback = async () => {
      ...
      if (error) {
        ...
        setErrorMessage(
          error_reason === 'user_denied' 
            ? 'You denied the Facebook authorization request' 
      ...
      try {
        ...
        // Get user's pages if they have any
        let accountType = 'personal';
        let accountName = profileData.name;
        ...
        try {
          ...
          console.log('Could not fetch pages, using personal account');
        }
        ...
        toast({
          ...
          description: `Your Facebook ${accountType} has been successfully connected.`,
        });
      ...
      <div className="min-h-screen flex items-center justify-center bg-background">
        <Card className="w-full max-w-md">
          <CardHeader className="text-center">
            ...
            <CardTitle>Connecting to Facebook</CardTitle>
            <CardDescription>
      ...
      <div className="min-h-screen flex items-center justify-center bg-background">
        <Card className="w-full max-w-md">
          <CardHeader className="text-center">
            ...
            <CardDescription>
              We couldn't complete your Facebook connection
            </CardDescription>
          </CardHeader>
          ...
          <div className="p-3 bg-green-50 border border-green-200 rounded-lg">
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm text-green-700">
                You can now schedule posts and manage your Facebook content
              </span>
            </div>
          </div>
