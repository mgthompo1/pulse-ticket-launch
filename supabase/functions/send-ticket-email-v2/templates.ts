                ...
                <tr>
                  <td style="vertical-align:top;width:60%;">
                    ...
                    <div style="margin-top:12px;">
                      <!-- Bulletproof Apple Wallet button for all email clients -->
                      <table role="presentation" cellpadding="0" cellspacing="0" border="0">
                        <tr>
                          <td align="left" valign="middle" style="padding:0;">
                            ...
                            <!--<![endif]-->
                            <!-- Live-text fallback if images are blocked -->
                            <div style="font-size:0;line-height:0;color:#000000;display:none;">
                              Add to Apple Wallet
                            </div>
                          </td>
                        </tr>
