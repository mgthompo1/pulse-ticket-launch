                ...
                <tr>
                  <td style="vertical-align:top;width:60%;">
                    ...
                    ${config.showWalletButton ? `<div style="margin-top:12px;">
                      <a href="${walletUrl}" style="display:inline-block;margin-right:8px;">
                        <img src="https://developer.apple.com/wallet/Add_to_Apple_Wallet_badge_black@2x.png" alt="Add to Apple Wallet" style="height:32px;width:auto;border:none;" />
                      </a>
                    </div>` : ''}
                  </td>
